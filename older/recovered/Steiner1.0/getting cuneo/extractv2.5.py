...
with open(key,'r') as key:
    for line in key:
        ...
        test = test.replace('\n','')
        test = test[0:10]
        if os.path.isfile('/home/thaddaeus/FMU/Steiner/PGX/MAXI4/'+test+'.log'):
            #print(test)
            ...
            raw = '/home/thaddaeus/FMU/Steiner/PGX/MAXI4/'+test+'.log'
            ...
            #Get unabs fluxes
            fluxfile = '/home/thaddaeus/FMU/Steiner/PGX/MAXI4/'+test+'cflux.log'
...
axs[0].set_yticks(np.arange(disktempmin,disktempmax,0.3))
...
axs[1].set_yticks(np.arange(gammamin,gammamax,0.4))
