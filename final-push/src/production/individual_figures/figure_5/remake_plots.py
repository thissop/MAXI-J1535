...
def grs_plots(): 
    ...
    for i in range(3):
        commands.append(f'cd /ar1/PROJ/fjuhsd/personal/thaddaeus/github/MAXI-J1535/final-push/data/sources/GRS_1915+105/qpo/external_PDS/{observation_IDs[i]}')
        ...
        commands.append('cd /ar1/PROJ/fjuhsd/personal/thaddaeus/github/MAXI-J1535/manuscript/figures/individual/figure_5')
        ...
        commands.append(f'hard  /ar1/PROJ/fjuhsd/personal/thaddaeus/github/MAXI-J1535/manuscript/figures/individual/figure_5/{observation_IDs[i]}[fig-5-pds-data].ps/ps')
        ...
        commands.append('csize 2.0')
        commands.append('rescale x 0.1 10')
        commands.append(f'hard  /ar1/PROJ/fjuhsd/personal/thaddaeus/github/MAXI-J1535/manuscript/figures/individual/figure_5/{observation_IDs[i]}[fig-5-pds-model].ps/ps')
    ...
    with open('/ar1/PROJ/fjuhsd/personal/thaddaeus/github/MAXI-J1535/final-push/src/production/individual_figures/figure_5/commands.sh', 'w') as f: 
