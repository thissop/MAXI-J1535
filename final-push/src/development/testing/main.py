...
def unprocessed_results_regression_test(): 
    ...
    collection_one.plot_results_regression(feature_name='frequency', which=[0], ax=ax)

    plt.savefig('/mnt/c/Users/Research/Documents/GitHub/MAXI-J1535/final-push/src/organize/with count rate/unprocessed_results_regression.png', dpi=150)
