...
qpo_path = '/mnt/c/Users/Research/Documents/GitHub/MAXI-J1535/final-push/data/pipeline/classification/MAXI_J1535-571_QPO-multiclass.csv'
...
collec.plot_confusion_matrix(fold=0, ax=ax, labels=['0 QPO', '1 QPO', '2 QPO'])

cm_path = f'/mnt/c/Users/Research/Documents/GitHub/MAXI-J1535/final-push/src/development/testing/topical/get_spectra_for_maxi/{model_name}-{source}-confusion_matrix-[MULTICLASS]'
fig.tight_layout()
...
roc_path = f'/mnt/c/Users/Research/Documents/GitHub/MAXI-J1535/final-push/src/development/testing/topical/get_spectra_for_maxi/{model_name}-{source}-ROC-[MULTICLASS]'
fig.tight_layout()
